...
{
    public class tb_plla_rubrosafectosleyestrabemplDA
    {
        public String Sql_Error = "";
        ConexionDA conex = new ConexionDA();

        public bool Insert(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosingreso_INSERT", cnx))
                {
        ...
        public bool Insert_Update(string empresaid, tb_plla_rubrosafectosleyestrabempl BE, DataTable TablaDatos)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                bool xreturn = true;
                int lcont = 0;
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectosleyestrabempl_Eliminar_A", cnx))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
                    cmd.Parameters.Add("@perimes", SqlDbType.Char, 2).Value = BE.perimes;
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectosleyestrabempl_InsertUpdate", cnx))
                    {
        ...
        public bool Update(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public bool Copiar(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public bool Delete(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public bool Eliminar(string empresaid, DataTable TablaDatos)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                for (lcont = 0; lcont <= TablaDatos.Rows.Count - 1; lcont++)
                {
                    using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosingreso_Eliminar", cnx))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@tipoplla", SqlDbType.Char, 1).Value = TablaDatos.Rows[lcont]["tipoplla"];
        ...
        public DataSet GetAll(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetAll_CONSULTA(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectosleyestrabempl_A", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_CONSULTA1(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetAll_IR(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetMAX_CODIGORUBROPLANILLA(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetOne(string empresaid, tb_plla_rubrosafectosleyestrabempl BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
