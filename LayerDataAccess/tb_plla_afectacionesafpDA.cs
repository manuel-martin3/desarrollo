...
{
    public class tb_plla_afectacionesafpDA
    {
        ...
        public bool Insert(string empresaid, tb_plla_afectacionesafp BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_INSERT", cnx))
                {
        ...
        public bool Insert_Update(string empresaid, tb_plla_afectacionesafp BE, DataTable TablaDatos)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                bool xreturn = true;
                int lcont = 0;
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_Eliminar", cnx))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
                    cmd.Parameters.Add("@perimes", SqlDbType.Char, 2).Value = BE.perimes;
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_InsertUpdate", cnx))
                    {
        ...
        public bool Update(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_UPDATE", cnx))
                {
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Delete(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public DataSet GetAll(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_CONSULTA(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_CONSULTA", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_CONSULTA1(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_CONSULTA1", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, tb_plla_afectacionesafp BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPllaRubrosafectacionesAFP_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
