...
{
    public class tb_cp_comercialcabDA
    {
        ...
        public bool Insert(string empresaid, tb_cp_comercialcab BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_UPDATE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public bool Delete(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public DataSet GetAll(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_SEARCH", cnx))
                {
        ...
        public DataSet GetAsientoNume(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_SEARCH_asientonume", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAsientoRoleo(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_SEARCH_roleo", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCpComercialcab_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
        ...
        public DataSet GetAll_paginacion(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbComercial_SEARCH_paginacion", cnx))
                {
                    DataSet ds = new DataSet();
                    {
        ...
        public DataSet GetAll_NuevoNumero(string empresaid, tb_cp_comercialcab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCmOrdenseries_Nuevonumero", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        ...
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
                        cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
                        cmd.Parameters.Add("@ser_op", SqlDbType.Char, 4).Value = BE.serop;
