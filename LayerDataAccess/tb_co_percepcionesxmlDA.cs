...
{
    public class tb_co_percepcionesxmlDA
    {
        ...
        public bool Insert(string empresaid, tb_co_percepcionesxml BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_INSERT", cnx))
                {
                    ...
                    cmd.Parameters.AddWithValue("@tipdid", string.IsNullOrEmpty(BE.tipdid) ? (object)DBNull.Value : BE.tipdid);
        ...
        public bool Insert_ImportaExcel(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_INSERT_ImportaExcel", cnx))
                {
                    cmd.CommandTimeout = 0;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public bool DELETE_ImportaExcel(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_DELETE_ImportaExcel", cnx))
                {
                    cmd.CommandTimeout = 0;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public bool Update(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_UPDATE", cnx))
                {
                    cmd.CommandTimeout = 0;
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public bool Delete(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                try
                {
                    using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_DELETE", cnx))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@perianio", SqlDbType.Char, 4).Value = BE.perianio;
        ...
        public DataSet ReporteLibroPercepciones(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_ReporteLibroPercepcion", cnx))
                {
        ...
        public DataSet ReporteLibroPercepcionesResumen(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_ReportePercepcionResumen", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetGeneraPDT0697Percepciones(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_GeneraDataPDTPercepciones", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetGeneraPDT0697Percepciones_CP(string empresaid, tb_co_percepcionesxml BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCoPercepcionesVtaInterna_GeneraDataPDTPercepciones_CP", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
