...
{
    public class mp_local_stock_inventario_rollo_cargaDA
    {
        ...
        public bool Insert(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_INSERT_xml", cnx))
                {
        ...
        public bool Update(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_Update_xml", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_DISTINDOC(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_DISTINDOC", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
        ...
        public DataSet GetOne_rollodoc(string empresaid, tb_mp_local_stock_inventario_rollo_carga BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpLocalStockInventarioRolloCarga_SELECT_rollodoc", cnx))
                {
                    DataSet ds = new DataSet();
