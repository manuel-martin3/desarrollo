...
{
    public class tb_60movimientosdetDA
    {
        ...
        public bool Update(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_Balance(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_Balance", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        ...
                        cmd.Parameters.Add("@productid", SqlDbType.Char, 13).Value = BE.productidini; // rango del codigo de producto
        ...
        public DataSet GetAll_Docsemitidos(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_Docsemitidos", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetAll_KardexEstacion(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_kardexEstacion", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetAll_HistorialxProducto(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_HistorialxProductos", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetAll_ConsumoxOP(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_ConsumoxOP", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetAll_rollokardex(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_kardexRollo", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetAll_productokardex_tela(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_kardexproducto_telas", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandTimeout = 0;
        ...
        public DataSet GetOne(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
        ...
        public DataSet Get_DocOP(string empresaid, tb_60movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdet_SEARCH_docuOP", cnx))
                {
                    DataSet ds = new DataSet();
