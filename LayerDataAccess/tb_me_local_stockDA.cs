...
{
    public class tb_me_local_stockDA
    {
        ConexionDA conex = new ConexionDA();

        public bool Insert(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_SEARCH", cnx))
                {
        ...
        public DataSet GetOne(string empresaid, string moduloid, string local, string productid)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
        ...
        public bool ReorgAnioMes(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_ReorgAnioMes", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public bool ReorgAnio(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_ReorgAnual", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public bool CierreDePeriodo(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_CierreMes", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll_productostock(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_SEARCH_stockactual", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_productostockxlocal(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_SEARCH_stockactualxlocal", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_modelostock(string empresaid, tb_me_local_stock BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeLocalStock_SEARCH_stockactual", cnx))
