...
{
    public class tb_pt_pedidoscabDA
    {
        ...
        public bool Insert(string empresaid, tb_pt_pedidoscab BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtPedidoscab_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpPedidoscab_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpPedidoscab_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtPedidoscab_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_pedidos(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtPedidoscab_SEARCH_pedidos", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_status(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtPedidoscab_SEARCH_status", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, tb_pt_pedidoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtPedidoscab_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
