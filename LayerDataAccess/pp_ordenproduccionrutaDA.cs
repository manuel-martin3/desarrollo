...
{
    public class pp_ordenproduccionrutaDA
    {
        ...
        public bool Insert(string empresaid, tb_pp_ordenproduccionruta BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPpOrdenproduccionruta_INSERT", cnx))
                {
                    ...
                    cmd.Parameters.Add("@faseshortname", SqlDbType.Char, 5).Value = BE.faseshortname;
        ...
        public bool Update(string empresaid, tb_pp_ordenproduccionruta BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPpOrdenproduccionruta_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_pp_ordenproduccionruta BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPpOrdenproduccionruta_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_pp_ordenproduccionruta BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPpOrdenproduccionruta_SEARCH", cnx))
                {
        ...
        public DataSet GetOne(string empresaid, tb_pp_ordenproduccionruta BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPpOrdenproduccionruta_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
