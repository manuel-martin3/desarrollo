...
{
    public class tb_pt_movimientosdetDA
    {
        ...
        public bool Insert(string empresaid, tb_pt_movimientosdet BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtMovimientosdet_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_pt_movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtMovimientosdet_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_pt_movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtMovimientosdet_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@moduloid", SqlDbType.Char, 4).Value = BE.moduloid;
        ...
        public DataSet GetAll(string empresaid, tb_pt_movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtMovimientosdet_SEARCH", cnx))
                {
        ...
        public DataSet GetOne(string empresaid, tb_pt_movimientosdet BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtMovimientosdet_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
