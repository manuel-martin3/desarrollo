...
{
    public class tb_me_planillacomisionDA
    {
        ...
        public DataSet GetAll(string empresaid, tb_me_planillacomision BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMePlanillacomisiondet_SEARCH", cnx))
                {
        ...
        public DataSet GetAll2(string empresaid, tb_me_planillacomision BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMePlanillacomisionDet_SEARCH_mensual", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
