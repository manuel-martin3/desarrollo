...
{
    public class tb_pt_movimientosDA
    {
        ...
        public bool Insert(string empresaid, tb_pt_movimientos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                using (SqlCommand cmd1 = new SqlCommand("gspTbPtMovimientoscab_INSERT", cnx))
                {
                    ...
                    using (SqlCommand cmd2 = new SqlCommand("gspTbPtMovimientosdet_INSERT_xml", cnx))
                    {
        ...
        public bool Update(string empresaid, tb_pt_movimientos BE1, tb_pt_movimientos BE2)
        {
            ...
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                using (SqlCommand cmd1 = new SqlCommand("gspTbPtMovimientoscab_UPDATE", cnx))
                {
                    cmd1.CommandType = CommandType.StoredProcedure;
                    ...
                    using (SqlCommand cmd2 = new SqlCommand("gspTbPtMovimientosdet_DELETE2", cnx))
                    {
                        cmd2.CommandType = CommandType.StoredProcedure;
                        ...
                        using (SqlCommand cmd3 = new SqlCommand("gspTbPtMovimientosdet_INSERT_xml", cnx))
                        {
        ...
        public bool Update_aprobado(string empresaid, tb_pt_movimientos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                SqlTransaction tr = default(SqlTransaction);
                ...
                using (SqlCommand cmd1 = new SqlCommand("gspTbPtMovimientoscab_UPDATE_aprobado", cnx))
                {
                    ...
                    using (SqlCommand cmd2 = new SqlCommand("gspTbPtMovimientosdet_UPDATE_aprobado", cnx))
                    {
                        ...
                        cmd2.Parameters.Add("@status", SqlDbType.Char, 1).Value = BE.status;
                        cmd2.Parameters.Add("@glosacredi", SqlDbType.VarChar, 300).Value = BE.glosacredi;
        ...
        public bool Delete(string empresaid, tb_pt_movimientos BE2)
        {
            //BE1: ingresa datos en tabla tb_pt_movimientosdet_delete
            //BE2: elimina datos de tabla tb_pt_movimientosdet
            ...
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                ...
                using (SqlCommand cmd1 = new SqlCommand("gspTbPtMovimientosdet_DELETE2", cnx))
                {
                    cmd1.CommandType = CommandType.StoredProcedure;
                    cmd1.Parameters.Add("@moduloid", SqlDbType.Char, 2).Value = BE2.moduloid;
                    ...
                    using (SqlCommand cmd2 = new SqlCommand("gspTbPtMovimientoscab_DELETE", cnx))
                    {
                        cmd2.CommandType = CommandType.StoredProcedure;
                        cmd2.Parameters.Add("@moduloid", SqlDbType.Char, 2).Value = BE2.moduloid;
                        cmd2.Parameters.Add("@local", SqlDbType.Char, 3).Value = BE2.local;
                        cmd2.Parameters.Add("@tipodoc", SqlDbType.Char, 2).Value = BE2.tipodoc;
                        cmd2.Parameters.Add("@serdoc", SqlDbType.Char, 4).Value = BE2.serdoc;
                        cmd2.Parameters.Add("@numdoc", SqlDbType.Char, 10).Value = BE2.numdoc;
