...
namespace LayerDataAccess
{
    public class mp_productosDA
    {
        ...
        public bool Insert(string empresaid, tb_mp_productos BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_INSERT", cnx))
                {
                    ...
                    cmd.Parameters.Add("@marcaid", SqlDbType.Char, 3).Value = BE.marcaid;
        ...
        public bool Update(string empresaid, tb_mp_productos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_UPDATE", cnx))
                {
        ...
        public bool Update2(string empresaid, tb_mp_productos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_UPDATE2", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_mp_productos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@productid", SqlDbType.Char, 13).Value = BE.productid;
        ...
        public DataSet GetAll(string empresaid, tb_mp_productos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_SEARCH", cnx))
                {
        ...
        public DataSet GetAll2(string empresaid, tb_mp_productos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_SEARCH2", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, string productid)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
        ...
        public DataSet GetAll_MaxMin(string empresaid)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpProductos_SEARCH_MaxMin", cnx))
                {
                    DataSet ds = new DataSet();
