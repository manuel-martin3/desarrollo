...
namespace LayerDataAccess
{
    public class tb_cm_conceptoDA
    {
        ...
        public bool Insert(string empresaid, tb_cm_conceptos BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Tienda_INSERT", cnx))
                {
        ...
        public bool Insert_Item(string empresaid, tb_cm_conceptos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public bool DeleteItem(string empresaid, tb_cm_conceptos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetAll(string empresaid, tb_cm_conceptos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbCmLiqConceptos_SELECT", cnx))
                {
                    ...
                    {
                        cmd.CommandType = CommandType.StoredProcedure;                        
                        cmd.Parameters.Add("@conceptoid", SqlDbType.Char, 5).Value = BE.conceptoid;
