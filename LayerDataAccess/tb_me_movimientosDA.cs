...
{
    public class tb_me_movimientosDA
    {
        ...
        public bool Insert(string empresaid, tb_me_movimientos BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeMovimientos_INSERT", cnx))
                {
        ...
        public DataSet Sunat141_RegVentas(string empresaid, tb_me_movimientoscab BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMeMovimientos_Sunat141_RegVentas", cnx))
                {
                    DataSet ds = new DataSet();
