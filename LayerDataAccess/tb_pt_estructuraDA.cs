...
{
    public class tb_pt_estructuraDA
    {
        ...
        public bool Insert(string empresaid, tb_pt_estructura BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_pt_estructura BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_pt_estructura BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@estructuraid", SqlDbType.Char, 1).Value = BE.estructuraid;
        ...
        public DataSet GetAll(string empresaid, tb_pt_estructura BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_paginacion(string empresaid, tb_pt_estructura BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_SEARCH_paginacion", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, string estructuraid)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbPtEstructura_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
