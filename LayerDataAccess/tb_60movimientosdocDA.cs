...
{
    public class tb_60movimientosdocDA
    {
        public String Sql_Error = "";
        ConexionDA conex = new ConexionDA();

        public bool Insert(string empresaid, tb_60movimientosdoc BE)
        {
        ...
        public bool Insert_Update(string empresaid, tb_60movimientosdoc BE, DataTable Detalle)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                bool xreturn = true;
        ...
        public bool Update(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public bool Delete(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
        ...
        public DataSet GetAll(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60Movimientosdoc_SEARCH", cnx))
                {
        ...
        public DataSet GetAll_CONSULTA(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60attachedfile_CONSULTA", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_CONSULTAIR(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60attachedfile_IR", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetAll_MaxCodigo(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTb60movimientosdoc_MaxCodigo", cnx))
                {
                    DataSet ds = new DataSet();
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetOne(string empresaid, tb_60movimientosdoc BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
