...
{
    public class mp_movimientosdet_deleteDA
    {
        ...
        public bool Insert(string empresaid, tb_mp_movimientosdet_delete BE)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpMovimientosdetDelete_INSERT", cnx))
                {
        ...
        public bool Update(string empresaid, tb_mp_movimientosdet_delete BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpMovimientosdetDelete_UPDATE", cnx))
                {
        ...
        public bool Delete(string empresaid, tb_mp_movimientosdet_delete BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpMovimientosdetDelete_DELETE", cnx))
                {
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@tipoalmac", SqlDbType.Char, 2).Value = BE.tipoalmac;
        ...
        public DataSet GetAll(string empresaid, tb_mp_movimientosdet_delete BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpMovimientosdetDelete_SEARCH", cnx))
                {
        ...
        public DataSet GetOne(string empresaid, tb_mp_movimientosdet_delete BE)
        {
            using (SqlConnection cnx = new SqlConnection(conex.empConexion(empresaid)))
            {
                using (SqlCommand cmd = new SqlCommand("gspTbMpMovimientosdetDelete_SELECT", cnx))
                {
                    DataSet ds = new DataSet();
