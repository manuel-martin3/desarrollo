...
{
    public class tb_plla_fichatrabajadorescontratosBL
    {
        public string Sql_Error = "";
        tb_plla_fichatrabajadorescontratosDA tablaDA = new tb_plla_fichatrabajadorescontratosDA();
        ...
        //public bool Reporte(string empresaid, tb_plla_fichatrabajadorescontratos BE, DataTable Detalle)
        //{
        //    //return tablaDA.Insert(empresaid, BE);
        //    //bool zreturn = tablaDA.GetReport(empresaid, BE, Detalle);
        //    //Sql_Error = tablaDA.Sql_Error;
        //    //return zreturn;
        //}
