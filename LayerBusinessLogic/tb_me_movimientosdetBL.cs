...
{
    public class tb_me_movimientosdetBL
    {
        tb_me_movimientosdetDA tablaDA = new tb_me_movimientosdetDA();
        ...
        {
            return tablaDA.ListadoComprasxModelo(empresaid, BE);
        }
        ...
        {
            return tablaDA.GetAll_productokardex(empresaid, BE);
        }
        #endregion
    }
}
