...
{
    public class tb_plla_geneventospermisoBL
    {
        public string Sql_Error = "";
        tb_plla_geneventospermisoDA tablaDA = new tb_plla_geneventospermisoDA();
        ...
        {
            //return tablaDA.GetAllTipoEvento(empresaid, BE);
            DataSet xreturn = null;
            xreturn = tablaDA.GetAllTipoEvento(empresaid, BE);
            Sql_Error = tablaDA.Sql_Error;
            return xreturn;
        }
