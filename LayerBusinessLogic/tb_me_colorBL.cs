...
{
    public class tb_me_colorBL
    {
        tb_me_colorDA tablaDA = new tb_me_colorDA();
        ...
        public DataSet GetAll(string empresaid, tb_me_color BE)
        {
        ...
        public DataSet GetOne(string empresaid, tb_me_color BE)
        {
