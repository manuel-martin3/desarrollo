...
{
    public class tb_plla_tipoplanillaBL
    {
        public string Sql_Error = "";
        tb_plla_tipoplanillaDA tablaDA = new tb_plla_tipoplanillaDA();
        ...
        {
            //return tablaDA.GetAll_ConsultaTipo(empresaid, BE);
            DataSet xreturn = null;
            xreturn = tablaDA.GetAll_ConsultaTipo(empresaid, BE);
            Sql_Error = tablaDA.Sql_Error;
            return xreturn;
        }
        ...
        public DataSet GetOne(string empresaid, string tipoplla)
        {
            ...
            DataSet xreturn = null;
            xreturn = tablaDA.GetOne(empresaid, tipoplla);
            Sql_Error = tablaDA.Sql_Error;
            return xreturn;
        }
    }
