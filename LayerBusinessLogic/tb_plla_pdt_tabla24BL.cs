...
{
    public class tb_plla_pdt_tabla24BL
    {
        public string Sql_Error = "";
        tb_plla_pdt_tabla24DA tablaDA = new tb_plla_pdt_tabla24DA();
        ...
        {
            //return tablaDA.GetOne(empresaid, cateocupid);
            DataSet xreturn = null;
            xreturn = tablaDA.GetOne(empresaid, cateocupid);
            Sql_Error = tablaDA.Sql_Error;
            return xreturn;
        }
    }
