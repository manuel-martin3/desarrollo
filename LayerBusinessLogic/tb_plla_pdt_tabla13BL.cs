...
{
    public class tb_plla_pdt_tabla13BL
    {
        public string Sql_Error = "";
        tb_plla_pdt_tabla13DA tablaDA = new tb_plla_pdt_tabla13DA();

        public bool Insert(string empresaid, tb_plla_pdt_tabla13 BE)
        {
        ...
        public bool Update(string empresaid, tb_plla_pdt_tabla13 BE)
        {
        ...
        public bool Delete(string empresaid, tb_plla_pdt_tabla13 BE)
        {
        ...
        public DataSet GetAll(string empresaid, tb_plla_pdt_tabla13 BE)
        {
        ...
        public DataSet GetAll_Consulta(string empresaid, tb_plla_pdt_tabla13 BE)
        {
