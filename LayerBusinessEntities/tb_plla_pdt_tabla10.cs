...
{
    public class tb_plla_pdt_tabla10
    {
        ...
        private String _ocupaname;
        public String ocupaname
        {
            get { return _ocupaname; }
            set { _ocupaname = value; }
        }

        private String _relcodigotipo;
        public String relcodigotipo
        {
            get { return _relcodigotipo; }
            set { _relcodigotipo = value; }
        }
