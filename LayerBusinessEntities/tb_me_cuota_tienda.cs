...
{
   public class tb_me_cuota_tienda
    {
        ...
        public string GetItemXML()
        {
            ...
            foreach (Item obj in _ListaItems)
            {
                ...
                XmlAttribute attrib4 = objNode.OwnerDocument.CreateAttribute("cuota"); attrib4.Value = obj.cuota.ToString();                
                XmlAttribute attrib5 = objNode.OwnerDocument.CreateAttribute("usuar"); attrib5.Value = obj.usuar.ToString();
