...
{
    public class tb_me_movimientos
    {

        #region tb_me_movimientos
        ...
        private String _xnumdoc1;
        public String xnumdoc1
        {
            get { return _xnumdoc1; }
            set { _xnumdoc1 = value; }
        }

        private String _xnumdoc2;
        public String xnumdoc2
        {
            get { return _xnumdoc2; }
            set { _xnumdoc2 = value; }
        }
        ...
        private Decimal _totcosto;
        public Decimal Totcosto
        {
            get { return _totcosto; }
            set { _totcosto = value; }
        }
        ...
        private Boolean? _princombo;
        public Boolean? princombo
        {
            get { return _princombo; }
            set { _princombo = value; }
        }

        private Int32 _cantcombo;
        public Int32 cantcombo
        {
            get { return _cantcombo; }
            set { _cantcombo = value; }
        }

        private Decimal _preccombo;
        public Decimal preccombo
        {
            get { return _preccombo; }
            set { _preccombo = value; }
        }

        private string _recep_name;
        public string recep_name
        {
            get { return _recep_name; }
            set { _recep_name = value; }
        }

        private string _recep_dni;
        public string recep_dni
        {
            get { return _recep_dni; }
            set { _recep_dni = value; }
        }

        private DateTime? _recep_fecha;
        public DateTime? recep_fecha
        {
            get { return _recep_fecha; }
            set { _recep_fecha = value; }
        }
        #endregion
        ...
        public class Item
        {
            ...
            private Int32 _promoid1;
            public Int32 promoid1
            {
                get { return _promoid1; }
                set { _promoid1 = value; }
            }

            private Int32 _promoid2;
            public Int32 promoid2
            {
                get { return _promoid2; }
                set { _promoid2 = value; }
            }

            private Int32 _promoid3;
            public Int32 promoid3
            {
                get { return _promoid3; }
                set { _promoid3 = value; }
            }
        ...
        public string GetItemXML()
        {
            ...
            foreach (Item obj in _ListaItems)
            {
                ...
                #region Para Ventas
                XmlAttribute attrib74 = objNode.OwnerDocument.CreateAttribute("listaprecid"); attrib74.Value = obj.listaprecid.ToString();
                XmlAttribute attrib75 = objNode.OwnerDocument.CreateAttribute("promoid1"); attrib75.Value = obj.promoid1.ToString();
                XmlAttribute attrib76 = objNode.OwnerDocument.CreateAttribute("promoid2"); attrib76.Value = obj.promoid2.ToString();
                XmlAttribute attrib77 = objNode.OwnerDocument.CreateAttribute("promoid3"); attrib77.Value = obj.promoid3.ToString();
                XmlAttribute attrib78 = objNode.OwnerDocument.CreateAttribute("preccosto"); attrib78.Value = obj.preccosto.ToString();
                XmlAttribute attrib79 = objNode.OwnerDocument.CreateAttribute("totcosto"); attrib79.Value = obj.totcosto.ToString();
                XmlAttribute attrib80 = objNode.OwnerDocument.CreateAttribute("colorid"); attrib80.Value = obj.colorid;
                XmlAttribute attrib81 = objNode.OwnerDocument.CreateAttribute("colorname"); attrib81.Value = obj.colorname;
                XmlAttribute attrib82 = objNode.OwnerDocument.CreateAttribute("tallaid"); attrib82.Value = obj.tallaid;
                XmlAttribute attrib83 = objNode.OwnerDocument.CreateAttribute("coltalla"); attrib83.Value = obj.coltalla;
                #endregion
                ...
                objNode.Attributes.Append(attrib79);
                objNode.Attributes.Append(attrib80);
                objNode.Attributes.Append(attrib81);
                objNode.Attributes.Append(attrib82);
                objNode.Attributes.Append(attrib83);
                #endregion
        ...
        public string TarjetasXML()
        {
            ...
            foreach (Tarjetas obj in ListaTarjetas)
            {
                ...
                XmlAttribute attrib5 = objNode.OwnerDocument.CreateAttribute("tarjimporte1"); attrib5.Value = obj.tarjimporte1.ToString();
                XmlAttribute attrib6 = objNode.OwnerDocument.CreateAttribute("tarjimporte2"); attrib6.Value = obj.tarjimporte2.ToString();
                XmlAttribute attrib7 = objNode.OwnerDocument.CreateAttribute("status"); attrib7.Value = obj.status.ToString();
                XmlAttribute attrib8 = objNode.OwnerDocument.CreateAttribute("usuar"); attrib8.Value = obj.usuar.ToString();
