...
public partial class tb_rrhh_Frm_proforma_pedido : System.Web.UI.Page
{
    ...
    private void CargarCorrelativoDoc()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //txt_proforma.Text = dt.Rows[0]["tipodoc"].ToString() + "-" + dt.Rows[0]["serdoc"].ToString() + Equivalencias.Right(dt.Rows[0]["numero"].ToString(), 6);
            ...
            //txt_proforma2.Text = dt.Rows[0]["tipodoc"].ToString() + "-" + dt.Rows[0]["serdoc"].ToString() + Equivalencias.Right(dt.Rows[0]["numero"].ToString(), 6);
        }
    }
