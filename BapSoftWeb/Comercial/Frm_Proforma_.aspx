<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_Proforma_.aspx.cs" Inherits="tb_rrhh_Frm_proforma_pedido" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="25px">
                                                        <asp:ImageButton ID="btn_Imprimir" runat="server" ImageUrl="~/images/btn_imprimir.png" 
                                                            style="width: 20px" ToolTip="Imprimir Contrato" OnClick="btn_Imprimir_Click" />
                                                    </td>
                                                    <td style="width:25px">
                                                        <asp:ImageButton ID="btn_Imprimir2" runat="server" ImageUrl="~/images/btn_imprimir.png" 
                                                            style="width: 20px" ToolTip="Imprimir Pedido" OnClick="btn_Imprimir2_Click" />
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                            ...
                                            <table id="Table3" runat="server" border="0"> 
                                                <tr>
                                                    ...
                                                    <td>
	                                                   ...
	                                                   <asp:ImageButton ID="btn_BuscarProforma" runat="server" ImageUrl="~/images/btn_buscar.png" ToolTip="Cargar Proforma" OnClick="btn_BuscarProforma_Click" />
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>
                                                        <asp:ImageButton ID="btn_evaluacion" runat="server" Height="20px" ImageUrl="~/images/go-next_g.png" OnClick="btn_evaluacion_Click" ToolTip="Evaluacion" Visible="False" />
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>                                   
                                            </table>
                                                ...
                                                <table runat="server" width="725px" border="0" cellspacing="00" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td align="right" width="100">
                                                            Tip.Venta:<br />                                                                                                                        
                                                            &nbsp;&nbsp;</td>
                                                        <td align="left" class="auto-style13" colspan="2">
                                                            <dx:ASPxComboBox ID="cmb_tipventa" runat="server" Theme="MetropolisBlue" Width="180px" AutoPostBack="true" OnSelectedIndexChanged="cmb_tipventa_SelectedIndexChanged">
                                                            </dx:ASPxComboBox>                                                                                                                        
                                                    ...
                                                    <tr>
                                                        <td align="right">&nbsp;</td>
                                                        <td align="right" width="100">Proforma:&nbsp;<br /> &nbsp; </td>
                                                        ...
                                                        <td align="right" class="auto-style10">Fech Doc:&nbsp;<br /> &nbsp;</td>
                                                        <td align="left" class="auto-style9">
                                                            <dx:ASPxDateEdit ID="fechdoc" runat="server" Theme="MetropolisBlue" Width="100px">
                                                            </dx:ASPxDateEdit>
                                                        ...
                                                        <td align="right" class="auto-style10">Entregar:&nbsp;<br /> &nbsp;<br /> </td>
                                                        <td align="left" class="auto-style9">
                                                            <dx:ASPxDateEdit ID="fechentrega" runat="server" Theme="MetropolisBlue" Width="100px">
                                                            </dx:ASPxDateEdit>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="2">
                                                            ...
                                                            <asp:TextBox ID="txt_ctactename" runat="server" TabIndex="2" Width="195px" CssClass="input_text_enabled" Enabled="False"></asp:TextBox>
                                                             <br />
                                                            <asp:RequiredFieldValidator ID="val_txt_ctacte" runat="server" CssClass="validacion" 
                                                                   ControlToValidate="txt_ctacte" ErrorMessage="Elegir Razòn Social" ValidationGroup="Validate">
                                                                 </asp:RequiredFieldValidator>                                    
                                                        </td>
                                                        <td align="right">
                                                            Ruc:<br /> &nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            Cond.Venta:&nbsp;<br /> &nbsp;</td>
                                                        <td align="left">                                                           
                                                            <dx:ASPxComboBox ID="cmb_condventaid" runat="server" Width="100px" AutoPostBack="true" Theme="MetropolisBlue" OnSelectedIndexChanged="cmb_condventaid_SelectedIndexChanged">                                                                
                                                            </dx:ASPxComboBox>
                                                       ...
                                                       <td align="right">
                                                           Plazo:&nbsp;<br /> &nbsp;</td>
                                                       <td align="left">                                                           
                                                            <dx:ASPxComboBox ID="cmb_plazoday" runat="server" Width="80px" Theme="MetropolisBlue"  AutoPostBack="true" OnSelectedIndexChanged="cmb_plazoday_SelectedIndexChanged">                                                                
                                                            </dx:ASPxComboBox>
                                                        ...
                                                        <td align="left">
                                                            <dx:ASPxComboBox ID="cmb_moneda" runat="server" Theme="MetropolisBlue" Width="80px">
                                                                <Items>
                                            ...
                                            <table runat="server" border="0" id="tblcrono">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" class="auto-style1">
                                                        <dx:ASPxComboBox ID="cmb_mediopagoid" runat="server" AutoPostBack="true" Theme="MetropolisBlue" Width="100px" OnSelectedIndexChanged="cmb_mediopagoid_SelectedIndexChanged">
                                                        </dx:ASPxComboBox>
                                                    </td>
                                                    <td align="right">Núm Docs:&nbsp;&nbsp;</td>
                                                    <td align="center">
                                                        <dx:ASPxSpinEdit ID="spe_numdocs" runat="server" AutoPostBack="true" Height="21px" Number="1" Theme="MetropolisBlue" Width="40px" OnNumberChanged="spe_numdocs_NumberChanged" MinValue="1" MaxLength="3" MaxValue="100">
                                                        </dx:ASPxSpinEdit>
                                                    </td>
                                                    <td align="right">&nbsp;</td>
                                                    <td align="right">
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <fieldset id="Field04" runat="server">
                                                ...
                                                <table runat="server">
                                                    <tr>
                                                        <td align="left" class="auto-style15">Bloquear</td>
                                                        <td align="left" class="auto-style4">&nbsp;Codigo:</td>
                                                        <td align="left" class="auto-style4"></td>
                                                        <td align="left" class="auto-style4">&nbsp;Marca:</td>
                                                        <td align="left" class="auto-style4">&nbsp;Articulo:</td>
                                                        <td align="left" class="auto-style4">Color:</td>
                                                        <td align="left" class="auto-style4">Talla:</td>
                                                        <td align="left" class="auto-style4">Cantidad:</td>
                                                        <td align="left" class="auto-style4">Prec.Lista:</td>
                                                        <td align="left" class="auto-style4"></td>
                                                        <td align="left" class="auto-style4"></td>
                                                        <td align="left" class="auto-style4"></td>
                                                        <td align="left" class="auto-style4"></td>                                                        
                                                    ...
                                                    <tr style="vertical-align:middle">
                                                        <td align="center">
                                                            <asp:CheckBox ID="chk_Bloquear" runat="server" ToolTip="Activar para bloquear Item" TextAlign="Left" BorderColor="LightBlue" BorderStyle="Solid" BorderWidth="2px" />
                                                            <br /><br />
                                                        </td>
                                                        <td align="left">                                                
                                                            ...
                                                            <asp:ImageButton ID="btn_buscar" runat="server" ImageUrl="~/images/btn_buscar.png" OnClick="btn_buscar_Click" ToolTip="Buscar Articulo" style="height: 16px" />                                                            
                                                             ...
                                                             <asp:RequiredFieldValidator ID="val_txt_articidold" runat="server" CssClass="validacion" 
                                                                   ControlToValidate="txt_articidold" ErrorMessage="Elegir color" ValidationGroup="Validate_2">
                                                           </asp:RequiredFieldValidator>                                                                                                                        
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td align="left">
                                                            ...
                                                            <br />
                                                            <asp:RequiredFieldValidator ID="val_txt_marcaname" runat="server" CssClass="validacion" 
                                                                   ControlToValidate="txt_marcaname" ErrorMessage="Elegir color" ValidationGroup="Validate_2">
                                                           </asp:RequiredFieldValidator>                                                              
                                                        </td>
                                                        <td align="left">
                                                            ...
                                                            <br />
                                                            <asp:RequiredFieldValidator ID="val_txt_articname" runat="server" CssClass="validacion" 
                                                                   ControlToValidate="txt_articname" ErrorMessage="Elegir color" ValidationGroup="Validate_2">
                                                           </asp:RequiredFieldValidator>  
                                                        </td>                                                        
                                                        <td align="left">
                                                                        <dx:ASPxComboBox ID="cmb_colorid" runat="server" Width="100px" Theme="MetropolisBlue">                                                               
                                                                        </dx:ASPxComboBox>
                                                        ...
                                                        <td align="left">
                                                             <dx:ASPxComboBox ID="cmb_tallaid" runat="server" Width="50px" Theme="MetropolisBlue">                                                                
                                                             </dx:ASPxComboBox>
                                                        ...
                                                        <td align="left">
                                                                     <dx:ASPxSpinEdit ID="spe_cantidad" runat="server" Height="21px" Number="1" Width="50px" Theme="MetropolisBlue" MaxValue="100" MinValue="1" MaxLength="3">
                                                                     </dx:ASPxSpinEdit> 
                                                            <br />
                                                                    </td>
                                                        <td align="left">&nbsp;
                                                            <asp:TextBox ID="txt_precventa_cre_menor" runat="server" Enabled="False" Width="50px"
                                                                            CssClass="input_text_enabled" MaxLength="4"></asp:TextBox>   
                                                            <br />
                                                            <br />
                                                        </td>
                                                        <td align="left"></td>
                                                        <td align="left">
                                                                ...
                                                                CssClass="boton_add2" TabIndex="24" OnClick="btn_add_Click" ValidationGroup="Validate_2"/>
                                                                    <br />
                                                                    <br />
                                                        </td>
                                                        <td align="left">                                                
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align:text-top" colspan="13">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <tr>                                                       
                                                                    ...
                                                                    <td style="text-align:center;">                                                                        
                                                                        <asp:Label ID="Label1" runat="server" Text="Total Items" Visible="false"></asp:Label>
                                                                    </td>
                                                                    <td></td>
                                                                    <td style="text-align:right;">Vta. Prec. Lista: </td>
                                                                    <td width="80px">
                                                                        <asp:TextBox ID="txt_impobruto" runat="server" Enabled="False" Width="80px"
                                                                            CssClass="_text2" BackColor="#FFCC00">0.00</asp:TextBox>
                                                                    </td>                                     
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td style="font-weight:bold;font-size:x-large; text-align:center;" rowspan="2">
                                                                        <asp:Label ID="items" runat="server" Text="0" ForeColor="Red" Font-Size="X-Large" Visible="False"></asp:Label>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="text-align:right;">%Dcscto: </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_tasadescto" runat="server" Enabled="False" Width="80px"
                                                                            CssClass="_text2" BackColor="#FFCC00">0.00</asp:TextBox>   
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="text-align:right;">Vta. Con Dscto:</td>
                                                                    <td>
                                                                        <asp:TextBox ID="txt_imponeto" runat="server" Enabled="False" Width="80px"
                                                                            CssClass="_text2" BackColor="#FFCC00">0.00</asp:TextBox>   
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                ...
                                                <table width="340" border="00" cellspacing="00" cellpadding="00">
                                                    <tr class="headPopup">
                                                        ...
                                                        <td width="320" align="right">
                                                            <asp:ImageButton runat="server" ID="btn_cerrar" ImageUrl="~/images/cerrar-form5.png"
                                            ...
                                            <ContentTemplate>
                                                <table width="640" border="00" cellspacing="00" cellpadding="00">
                                                    <tr class="headPopup">
                                                        ...
                                                        <td width="320" align="right">
                                                            <asp:ImageButton runat="server" ID="ImageButton1" ImageUrl="~/images/cerrar-form5.png"
