...
public partial class Comercial_Reportes_Rpt_Pedido : System.Web.UI.Page
{
    ...
    private void Rpt_Pedido()
    {
        try
        {
            ...
            rect = new XRect(leftMargin + 60, topMargin + 100, 220, 100);
            gfx.DrawRectangle(XBrushes.White, rect);
            tf.Alignment = XParagraphAlignment.Justify;
            tf.DrawString(": " + XDIRECENTREGA + "", font2, XBrushes.Black, rect, XStringFormats.TopLeft);


            gfx.DrawString("NUM-CONTRATO", font, XBrushes.Black, new XRect(leftMargin, topMargin + 120, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XNUMDOC + "", font2, XBrushes.Black, new XRect(leftMargin + 60, topMargin + 120, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString("COND-VENTA : ", font, XBrushes.Black, new XRect(leftMargin, topMargin + 130, 10, 10), XStringFormats.TopLeft);

            // DIBUJAR UN RECTANGULO
            pen = new XPen(XColors.Black, 2);
            gfx.DrawRoundedRectangle(pen, leftMargin + 57, topMargin + 135, 90, 30, 25, 25);
            gfx.DrawString("CONTADO", font, XBrushes.Black, new XRect(leftMargin + 70, topMargin + 138, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XCO + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 138, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString("CREDITO", font, XBrushes.Black, new XRect(leftMargin + 70, topMargin + 149, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XCR + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 149, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("PLAZO EN DIAS", font, XBrushes.Black, new XRect(leftMargin + 150, topMargin + 149, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XPLAZODAY + " DIAS", font2, XBrushes.Black, new XRect(leftMargin + 210, topMargin + 149, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("VENTA TOTAL A PRECIO DE LISTA", font, XBrushes.Black, new XRect(leftMargin, topMargin + 170, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XIMPOBRUTO.ToString("##,###,##0.00") + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 170, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("TASA DE DESCUENTO", font, XBrushes.Black, new XRect(leftMargin, topMargin + 180, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XTASADESCTO + "%", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 180, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("VENTA TOTAL CON DESCUENTO", font, XBrushes.Black, new XRect(leftMargin, topMargin + 190, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XIMPONETO.ToString("##,###,##0.00") + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 190, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("PRECIOS DE LOS PRODUCTOS", font, XBrushes.Black, new XRect(leftMargin, topMargin + 200, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XNMONE + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 200, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString("LOS PRECIOS INCLUYEN IGV", font, XBrushes.Black, new XRect(leftMargin, topMargin + 210, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(": " + XIGV + "", font2, XBrushes.Black, new XRect(leftMargin + 120, topMargin + 210, 10, 10), XStringFormats.TopLeft);
            ...
            gfx.DrawString(("CODIGO").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 5, topMargin + 238, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("MARCA").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 35, topMargin + 238, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("PRODUCTO").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 80, topMargin + 238, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("COLOR").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 250, topMargin + 238, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("TALLA").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 295, topMargin + 238, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("CANTIDAD").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 318, topMargin + 238, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString(("PRECIOS DE").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 350, topMargin + 235, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("LISTA").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 358, topMargin + 245, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString(("VENTAS A").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 400, topMargin + 235, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("PRECIOS DE LISTA").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 390, topMargin + 245, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString(("PRECIOS CON").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 450, topMargin + 235, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("DESCUENTO").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 451, topMargin + 245, 10, 10), XStringFormats.TopLeft);

            gfx.DrawString(("VENTAS CON").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 500, topMargin + 235, 10, 10), XStringFormats.TopLeft);
            gfx.DrawString(("DESCUENTO").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 501, topMargin + 245, 10, 10), XStringFormats.TopLeft);

            pen = new XPen(XColors.Black, 2);
            gfx.DrawLine(pen, 40, 275, 580, 275);
            ...
            foreach (DataRow fila in tabla02.Rows)
            {
                ...
                gfx.DrawString((fila["articidold"].ToString()).PadRight(19, ' '),
                    font, XBrushes.Black, new XRect(leftMargin + 5, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((fila["marcaname"].ToString()).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 35, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((fila["articname"].ToString()).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 80, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((fila["colorname"].ToString()).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 250, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((fila["talla"].ToString()).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 299, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((fila["cantidad"].ToString()).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 318, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((precbruto.ToString("##,###,##0.00")).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 358, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((impobruto.ToString("##,###,##0.00")).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 400, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((precneto.ToString("##,###,##0.00")).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 458, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                gfx.DrawString((imponeto.ToString("##,###,##0.00")).PadRight(19, ' '),
                   font, XBrushes.Black, new XRect(leftMargin + 508, topMargin + 242 + n2, 10, 10), XStringFormats.TopLeft);
                n2 = n2 + 10;
                nfilas = nfilas + 12;
            }
            ...
            gfx.DrawRoundedRectangle(pen, leftMargin + 0, topMargin + 234, 540, nfilas, 25, 25);
            //PIE DEL RECTANGULO
            gfx.DrawLine(pen, 40, topMargin + 229 + (nfilas - 12), 580, topMargin + 229 + (nfilas - 12));
            font = new XFont("Abadi MT Condensed Light", 8, XFontStyle.Bold);
            gfx.DrawString(("TOTAL").PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 80, topMargin + 230 + (nfilas - 10), 10, 10), XStringFormats.TopLeft);

            gfx.DrawString((XIMPOBRUTO.ToString("##,###,##0.00")).PadRight(19, ' '),
                font, XBrushes.Black, new XRect(leftMargin + 400, topMargin + 230 + (nfilas - 10), 10, 10), XStringFormats.TopLeft);
            gfx.DrawString((XIMPONETO.ToString("##,###,##0.00")).PadRight(19, ' '),
               font, XBrushes.Black, new XRect(leftMargin + 508, topMargin + 230 + (nfilas - 10), 10, 10), XStringFormats.TopLeft);
