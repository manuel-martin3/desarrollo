<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_PaginaError_400.aspx.cs" Inherits="Frm_PaginaError_400" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <br /><br />
                            <h1 class="brand-heading">¡Error 400!</h1>
                           <p class="intro-text"><i class="fa fa-lock fa-3x animated"></i> 
                           Ocurrió un error durante la operación, 
                           <br />por favor vuelva a ingresar los datos e intentarlo nuevamente.</p>
                            <center>
                            ...
                            <asp:LinkButton ID="LkBExit" runat="server" CssClass="btn btn-circle" PostBackUrl="~/Login.aspx">
                                <i class="fa fa-reply animated"></i>
                            </asp:LinkButton>                          
