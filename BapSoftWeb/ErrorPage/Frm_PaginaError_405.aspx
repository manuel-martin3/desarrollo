<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Frm_PaginaError_405.aspx.cs" Inherits="Frm_PaginaError_405" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <br /><br />
                            <h1 class="brand-heading">¡Error 405!</h1>
                           <p class="intro-text"><i class="fa fa-eye-slash fa-3x animated"></i> 
                           ...
                           <br />por favor vuelva a intentarlo nuevamente.</p>
                            ...
                            <asp:LinkButton ID="LkBExit" runat="server" CssClass="btn btn-circle" PostBackUrl="~/Comercial/Frm_Proformas.aspx">
