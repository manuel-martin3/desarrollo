...
{
    public partial class Frm_reporte_explosion_material : plantilla
    {
        ...
        public Frm_reporte_explosion_material()
        {
            InitializeComponent();
        ...
        private void Frm_reporte_explosion_material_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btn_imprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                miForma.formulario = "Frm_reporte_explosion_material";
                miForma.Show();
            }
            catch (Exception ex)
            {
