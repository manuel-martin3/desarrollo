...
{
    public partial class Frm_modulo_local_tipodoc : plantilla
    {
        ...
        public Frm_modulo_local_tipodoc()
        {
            InitializeComponent();
        }
        ...
        private void SEGURIDAD_LOG(String accion)
        {
            ...
            {
                case "MainMercaderia":
                    perianio = ((MERCADERIA.MainMercaderia)MdiParent).perianio;
                    break;
                case "MainAlmacen":
            ...
            var xclave = VariablesPublicas.EmpresaID + "/" + perianio;
            try
            {
        ...
        private void limpiar_documento()
        {
            try
            {
                ...
                _nlineas.Text = string.Empty;
                _sermaq.Text = string.Empty;
                ncaja.Text = string.Empty;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            BE.serdoc2 = tipodocseries2.Text.Trim().PadLeft(4, '0');
                            BE.numero = Convert.ToInt16(tipodocserienumero.Text.Trim().PadLeft(1, '0'));

                            if (_nlineas.Text.ToString().Length > 0)
                            {
                                BE.nlineas = Convert.ToInt32(_nlineas.Text);
                            }
                            BE.sermaq = _sermaq.Text;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            BE.serdoc = tipodocserie.Text.Trim().PadLeft(4, '0');
                            BE.serdoc2 = tipodocseries2.Text.Trim().PadLeft(4, '0');
                            BE.numero = Convert.ToInt32(tipodocserienumero.Text.Trim().PadLeft(1, '0'));
                            if (_nlineas.Text.ToString().Length > 0)
                            {
                                BE.nlineas = Convert.ToInt32(_nlineas.Text);
                            }
        ...
        private void Frm_modulo_local_tipodoc_Load(object sender, EventArgs e)
        {
            switch (this.Parent.Parent.Name)
            {
                case "MainMercaderia":
        ...
        {
            Tablatipodocserie = new DataTable("TablaTipoDocSeries");
            Tablatipodocserie.Columns.Add("dominioid", typeof(String));
            Tablatipodocserie.Columns.Add("moduloid", typeof(String));
            Tablatipodocserie.Columns.Add("local", typeof(String));
            Tablatipodocserie.Columns.Add("tipodoc", typeof(String));
            Tablatipodocserie.Columns.Add("serdoc", typeof(String));
            Tablatipodocserie.Columns.Add("numero", typeof(Decimal));
            Tablatipodocserie.Columns.Add("usuar", typeof(String));
            Tablatipodocserie.Columns.Add("fecre", typeof(DateTime));
            Tablatipodocserie.Columns.Add("feact", typeof(DateTime));
            Tablatipodocserie.Columns.Add("status", typeof(String));
            Tablatipodocserie.Columns.Add("tipodocname", typeof(String));
            Tablatipodocserie.Columns.Add("nlineas", typeof(Int32));
            Tablatipodocserie.Columns.Add("sermaq", typeof(String));

            Tablatipodocserie.Columns.Add("ncaja", typeof(String));
            Tablatipodocserie.PrimaryKey = new DataColumn[] { Tablatipodocserie.Columns["ncaja"] };
            Tablatipodocserie.Columns["ncaja"].Unique = true;
        }


        private void Frm_modulo_local_tipodoc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void gridtipodoc_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            gridtipodoc.EnableHeadersVisualStyles = false;
            gridtipodoc.ColumnHeadersDefaultCellStyle.BackColor = Color.Teal;
            gridtipodoc.ColumnHeadersDefaultCellStyle.ForeColor = Color.FromArgb(255, 255, 255);
        }
        ...
        private void btn_editarsd_Click(object sender, EventArgs e)
        {
            ...
            tipodocserie.Enabled = true;
            tipodocseries2.Enabled = true;
            _nlineas.Enabled = true;
            _sermaq.Enabled = true;
            ncaja.Enabled = true;
        ...
        private void btn_calcelarsd_Click(object sender, EventArgs e)
        {
            ...
            tipodocseries2.Enabled = false;
            tipodocserienumero.Enabled = false;
            _nlineas.Enabled = false;
            _sermaq.Enabled = false;
            ncaja.Enabled = false;
            btn_nuevosd.Enabled = true;
            btn_grabarsd.Enabled = false;
            btn_eliminarsd.Enabled = false;
        ...
        private void gridtipodocserie_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            gridtipodocserie.EnableHeadersVisualStyles = false;
            gridtipodocserie.ColumnHeadersDefaultCellStyle.BackColor = Color.Teal;
            gridtipodocserie.ColumnHeadersDefaultCellStyle.ForeColor = Color.FromArgb(255, 255, 255);
        }
        ...
        private void data_tipodocserie(String xserdoc)
        {
            ...
            if (rowtipodoc.Length > 0)
            {
                foreach (DataRow row in rowtipodoc)
                {
                    ...
                    tipodocseries2.Text = row["serdoc2"].ToString().Trim();
                    tipodocserienumero.Text = row["numero"].ToString().Trim();
                    _nlineas.Text = row["nlineas"].ToString().Trim();
                    _sermaq.Text = row["sermaq"].ToString().Trim();
                    ncaja.Text = row["ncaja"].ToString().Trim();
        ...
        private void tabtipodocserie_Click(object sender, EventArgs e)
        {
        }
    }
}
