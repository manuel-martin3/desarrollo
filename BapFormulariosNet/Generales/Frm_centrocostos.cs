...
namespace BapFormulariosNet.GENERALES
{
    public partial class Frm_centrocostos : plantilla
    {
        ...
        private void U_RefrescaControles()
        {
            ...
            chkanalitica.Enabled = xEnabled1;
            ...
            if (sw_prosigue)
            {
                if ((tmpcursor != null))
                {
                    ...
                    try
                    {
                        ...
                        xtmpuser = gridcentrocostos.Rows[filaactual].Cells["cencosid"].ToString();
                    }
                    catch (Exception ex)
                    {
                        xtmpuser = "..11";
                ...
                if (gridcentrocostos.RowCount > 0)
                {
                    ...
                    {
                        if (gridcentrocostos.Rows[lc_cont].Cells["cencosid"].ToString() == xtmpuser)
                        {
