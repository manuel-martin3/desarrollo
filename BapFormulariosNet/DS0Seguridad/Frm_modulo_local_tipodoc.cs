...
namespace BapFormulariosNet.DS0Seguridad
{
    public partial class Frm_modulo_local_tipodoc : plantilla
    {
        ...
        DataTable Tablatipodoc;
        DataTable Tablatipodocserie;
        ...
        private void AyudaModulo(String lpdescrlike)
        {
            try
            {
                ...
                frmayuda.sqlinner = ""; //inner
                frmayuda.sqlwhere = "where dominioid = '" + dominioid.Text.Trim() + "'"; //where
        ...
        private void AyudaLocal(String lpdescrlike)
        {
            try
            {
                ...
                frmayuda.sqlinner = ""; //inner
                frmayuda.sqlwhere = "where dominioid = '" + dominioid.Text.Trim() + "' and moduloid = '" + moduloid.Text.Trim() + "'"; //where
                frmayuda.sqland = "and";//and
        ...
        private void AyudaTipodoc(String lpdescrlike)
        {
            try
            {
                ...
                frmayuda.sqlinner = "inner join tb_sys_dominio tsd on ttd.dominioid = tsd.dominioid " +
                                    ...
                                    "inner join tb_sys_local tsl on ttd.dominioid = tsl.dominioid and ttd.moduloid = tsl.moduloid and ttd.[local] = tsl.[local]"; //inner
                frmayuda.sqlwhere = "where"; //where
                frmayuda.sqland = "";//and
        ...
        private void limpiar_documento()
        {
            try
            {
                ...
                almacaccionid.Text = "";
                tipodoccontratipo.Text = "";
                tipodoctipotransac.Text = "";
                tipodocstatcostopromed.Text = "";
                ctacteaccionid.Text = "";
                manejaastocont.Text = "";
                mensaje.Text = "";

                //txt_dominioid.Text = "";
                //txt_dominioname.Text = "";
                //txt_moduloid.Text = "";
                //txt_moduloname.Text = "";
                //txt_local.Text = "";
                //txt_localname.Text = "";
                txt_tipodoc.Text = "";
                txt_tipodocname.Text = "";
                tipodocserie.Text = "";
        ...
        private void Insert_serdoc()
        {
            try
            {
                ...
                else if (txt_tipodoc.Text.Trim().Length != 2)
                {
                    MessageBox.Show("Falta Tipo de Documento !!!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                else if (tipodocserie.Text.Trim().Length != 4)
                {
        ...
        private void Frm_modulo_local_tipodoc_Activated(object sender, EventArgs e)
        {
        ...
        private void btn_imprimir_Click(object sender, EventArgs e)
        {
            try
            {
                if (Tablatipodoc.Rows.Count > 0)
                {
                    ...
                    //miForma.formulario = "Frm_modulo_local_tipodoc";
                    //miForma.ShowDialog();
                }
        ...
        private void gridtipodoc_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    String xdominioid = "", xmoduloid = "", xxlocal = "", xtipodoc = "";
        ...
        {
            form_bloqueado(false);
            DataRow[] rowtipodoc = Tablatipodoc.Select("dominioid='" + xdominioid.Trim() + "' and moduloid= '" + xmoduloid.Trim() +
        ...
        {
            DataRow[] rowtipodoc = Tablatipodocserie.Select("serdoc='" + xserdoc.Trim() + "'");
            if (rowtipodoc.Length > 0)
            {
                foreach (DataRow row in rowtipodoc)
                {
