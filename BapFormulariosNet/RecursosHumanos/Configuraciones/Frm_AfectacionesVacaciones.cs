...
{
    public partial class Frm_AfectacionesVacaciones : plantilla
    {
        ...
        public Frm_AfectacionesVacaciones()
        {
            InitializeComponent();

            KeyDown += Frm_AfectacionesVacaciones_KeyDown;
            FormClosing += Frm_AfectacionesVacaciones_FormClosing;
            Load += Frm_AfectacionesVacaciones_Load;
            Activated += Frm_AfectacionesVacaciones_Activated;
        }

        private void Frm_AfectacionesVacaciones_Activated(object sender, EventArgs e)
        {
            if (Sw_LOad)
            {
        ...
        private void Frm_AfectacionesVacaciones_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
            WindowState = FormWindowState.Normal;
            Examinar.Columns["rubroname"].Width = 330;
            Examinar.Columns["afecto"].HeaderText = "Afecto";
        ...
        private void CargaDatos()
        {
            ...
            var BL = new tb_plla_afectacionesvacBL();
            var BE = new tb_plla_afectacionesvac();
        ...
        private void Frm_AfectacionesVacaciones_FormClosing(object sender, FormClosingEventArgs e)
        {
            if ((u_n_opsel > 0))
            {
        ...
        private void Frm_AfectacionesVacaciones_KeyDown(object sender, KeyEventArgs e)
        {
