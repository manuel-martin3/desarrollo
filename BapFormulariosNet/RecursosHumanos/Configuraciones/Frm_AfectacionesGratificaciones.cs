...
{
    public partial class Frm_AfectacionesGratificaciones : plantilla
    {
        ...
        public Frm_AfectacionesGratificaciones()
        {
            InitializeComponent();

            KeyDown += Frm_AfectacionesGratificaciones_KeyDown;
            FormClosing += Frm_AfectacionesGratificaciones_FormClosing;
            Load += Frm_AfectacionesGratificaciones_Load;
            Activated += Frm_AfectacionesGratificaciones_Activated;
        }

        private void Frm_AfectacionesGratificaciones_Activated(object sender, EventArgs e)
        {
            if (Sw_LOad)
            {
        ...
        private void Frm_AfectacionesGratificaciones_Load(object sender, EventArgs e)
        {
            MaximizeBox = false;
        ...
        private void Frm_AfectacionesGratificaciones_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (u_n_opsel > 0)
            {
        ...
        private void Frm_AfectacionesGratificaciones_KeyDown(object sender, KeyEventArgs e)
        {
