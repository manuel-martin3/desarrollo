...
{
    public partial class Frm_Planilla_RubrosAportaciones : plantilla
    {
        ...
        public Frm_Planilla_RubrosAportaciones()
        {
            InitializeComponent();

            KeyDown += Frm_Planilla_RubrosAportaciones_KeyDown;
            FormClosing += Frm_Planilla_RubrosAportaciones_FormClosing;
            Load += Frm_Planilla_RubrosAportaciones_Load;
            Activated += Frm_Planilla_RubrosAportaciones_Activated;
        ...
        private void Frm_Planilla_RubrosAportaciones_Load(object sender, EventArgs e)
        {
        ...
        private void U_RefrescaControles()
        {
            ...
            btneliminar.Enabled = u_n_opsel == 0 & xcodcliente.Trim().Length > 0;
        ...
        private void Frm_Planilla_RubrosAportaciones_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (u_n_opsel > 0)
            {
        ...
        private void Frm_Planilla_RubrosAportaciones_KeyDown(object sender, KeyEventArgs e)
        {
