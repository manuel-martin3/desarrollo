...
{
    public partial class Frm_help_producto : Form
    {
        ...
        private void _recarga()
        {
            ...
            gridgeneral.Columns["nserie"].ReadOnly = true;
            gridgeneral.Columns["lineaid"].ReadOnly = true;
            gridgeneral.Columns["lineaname"].ReadOnly = true;
            gridgeneral.Columns["grupoid"].ReadOnly = true;
            gridgeneral.Columns["gruponame"].ReadOnly = true;
            gridgeneral.Columns["subgrupoid"].ReadOnly = true;
            gridgeneral.Columns["subgrupoartic"].ReadOnly = true;

            gridgeneral.RowHeadersVisible = false;
        }
            ...
            try
            {
                foreach (DataGridViewRow fila in gridgeneral.Rows)
                {
                    ...
                    if (xselec == true)
                    {
                        ...
                        row["nserie"] = gridgeneral.Rows[fila.Index].Cells["nserie"].Value;
                        ...
                        row["grupoid"] = gridgeneral.Rows[fila.Index].Cells["grupoid"].Value;
                        row["gruponame"] = gridgeneral.Rows[fila.Index].Cells["gruponame"].Value;
                        row["subgrupoid"] = gridgeneral.Rows[fila.Index].Cells["subgrupoid"].Value;
                        row["subgrupoartic"] = gridgeneral.Rows[fila.Index].Cells["subgrupoartic"].Value;
        ...
        private void Frm_help_producto_Activated(object sender, EventArgs e)
        {
            if (Inicializa)
            {
                Inicializa = false;
        ...
        private void Frm_help_producto_Load(object sender, EventArgs e)
        {
            Tabladet = new DataTable("DetalleProductos");
            ...
            Tabladet.Columns.Add("nserie", typeof(String));
            Tabladet.Columns.Add("lineaid", typeof(String));
            Tabladet.Columns.Add("lineaname", typeof(String));
            Tabladet.Columns.Add("grupoid", typeof(String));
            Tabladet.Columns.Add("gruponame", typeof(String));
            Tabladet.Columns.Add("subgrupoid", typeof(String));
            Tabladet.Columns.Add("subgrupoartic", typeof(String));
        ...
        private void Frm_help_producto_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
        ...
        private void chk_todos_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                for (var i = 0; i < gridgeneral.RowCount; i++)
                {
                    gridgeneral.Rows[i].DataGridView[0, i].Value = true;
                }
            }
            else
            {
                for (var i = 0; i < gridgeneral.RowCount; i++)
                {
                    gridgeneral.Rows[i].DataGridView[0, i].Value = false;
                }
            }
        }
    }
