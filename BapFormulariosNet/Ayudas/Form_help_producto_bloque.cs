...
{
    public partial class Form_help_producto_bloque : Form
    {
        ...
        public Form_help_producto_bloque()
        {
            InitializeComponent();
            checkboxColumn();
        ...
        private void datos_seleccionados()
        {
            ...
            try
            {
                //gridgeneral.CurrentCell = gridgeneral.Rows[gridgeneral.CurrentRow.Index].Cells[1];
                foreach (DataGridViewRow fila in gridgeneral.Rows)
                {
                    ...
                    if (xselec == true)
                    {
                        ...
                        row["cantidad"] = gridgeneral.Rows[fila.Index].Cells["cantidad"].Value;
        ...
        private void Frm_help_general_Load(object sender, EventArgs e)
        {
            ...
            Tabladet.Columns.Add("cantidad", typeof(Int32));
            Tabladet.Columns.Add("bloqueid", typeof(String));
            Tabladet.Columns.Add("bloquename", typeof(String));            
