...
{
    public partial class Form_help_stockinventario_rollo : Form
    {
        ...
        public Form_help_stockinventario_rollo()
        {
            InitializeComponent();
            checkboxColumn();
        ...
        private void _recarga()
        {
            ...
            gridgeneral.Columns["rollo"].ReadOnly = true;
            ...
            try
            {
                foreach (DataGridViewRow fila in gridgeneral.Rows)
                {
                    ...
                    if (xselec == true)
                    {
                        ...
                        row["rollo"] = gridgeneral.Rows[fila.Index].Cells["rollo"].Value;
