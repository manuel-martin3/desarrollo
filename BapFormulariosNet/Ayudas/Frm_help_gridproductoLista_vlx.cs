...
{
    public partial class Frm_help_gridproductoLista_vlx : Form
    {
        ...
        public Frm_help_gridproductoLista_vlx()
        {
            InitializeComponent();
            checkboxColumn();
        ...
        private void _recarga()
        {
            if (gridgeneral.Rows.Count > 0)
            {
                ...
                gridgeneral.Columns["precunit"].ReadOnly = true;
            ...
            try
            {
                foreach (DataGridViewRow fila in gridgeneral.Rows)
                {
                    ...
                    if (xselec == true)
                    {
                        ...
                        row["precunit"] = gridgeneral.Rows[fila.Index].Cells["precunit"].Value;
        ...
        private void Frm_help_general_Load(object sender, EventArgs e)
        {
            ...
            Tabladet.Columns.Add("precunit", typeof(Decimal));
            Tabladet.Columns["precunit"].DefaultValue = 0;
