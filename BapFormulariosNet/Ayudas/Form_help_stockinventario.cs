...
{
    public partial class Form_help_stockinventario : Form
    {
        ...
        public Form_help_stockinventario()
        {
            InitializeComponent();
            checkboxColumn();
        ...
        private void _recarga()
        {
            ...
            gridgeneral.Columns["stocklibros"].ReadOnly = true;
            gridgeneral.Columns["stockfisico"].ReadOnly = true;
            gridgeneral.Columns["diferencia"].ReadOnly = true;
            gridgeneral.Columns["costopromlibros"].ReadOnly = true;
            gridgeneral.Columns["costopromfisico"].ReadOnly = true;
        }
            ...
            try
            {
                foreach (DataGridViewRow fila in gridgeneral.Rows)
                {
                    ...
                    if (xselec == true)
                    {
                        ...
                        row["stocklibros"] = gridgeneral.Rows[fila.Index].Cells["stocklibros"].Value;
                        row["stockfisico"] = gridgeneral.Rows[fila.Index].Cells["stockfisico"].Value;
                        row["diferencia"] = gridgeneral.Rows[fila.Index].Cells["diferencia"].Value;

                        row["costopromlibros"] = gridgeneral.Rows[fila.Index].Cells["costopromlibros"].Value;
                        row["costopromfisico"] = gridgeneral.Rows[fila.Index].Cells["costopromfisico"].Value;
        ...
        private void Frm_help_general_Load(object sender, EventArgs e)
        {
            ...
            Tabladet.Columns.Add("stocklibros", typeof(Decimal));
            Tabladet.Columns.Add("stockfisico", typeof(Decimal));
            Tabladet.Columns.Add("diferencia", typeof(Decimal));
            Tabladet.Columns.Add("costopromlibros", typeof(Decimal));
            Tabladet.Columns.Add("costopromfisico", typeof(Decimal));
        ...
        public void txt_busqueda_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
        ...
        public void txt_busqueda_KeyPress(object sender, KeyPressEventArgs e)
        {
        }
    }
}
