...
{
    public partial class Form_help_gridproducto : Form
    {
                ...
                using (var cmd = new SqlCommand("gspHelpSQL", cnx))
                {
                    ...
                    try
                    {
                        ...
                        using (var da = new SqlDataAdapter(cmd))
                        {
                            ...
                            if (xmoduloid == "0900" || xmoduloid == "0200")
                            {
                                var xxData = "select * from tb_ta_familiadet where familiaid = '" + xfamiliaid + "'";
                                var dt2 = new DataTable();
                                dt2 = ProdMov(xxData);
                                ...
                                foreach (DataGridViewRow fila in gridgeneral.Rows)
                                {
                                    ...
                                    {
                                        var x2 = dt2.Rows[i]["productid"].ToString();
