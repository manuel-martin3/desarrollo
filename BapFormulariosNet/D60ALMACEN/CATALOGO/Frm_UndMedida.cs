...
namespace BapFormulariosNet.D60ALMACEN.CATALOGO
{
    public partial class Frm_UndMedida : plantilla
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            undcodigoid.Text = Convert.ToString(BE.codigoid);
        ...
        private void gridcolor_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            gridunidmed.EnableHeadersVisualStyles = false;
            gridunidmed.ColumnHeadersDefaultCellStyle.BackColor = Color.Teal;
            gridunidmed.ColumnHeadersDefaultCellStyle.ForeColor = Color.FromArgb(255, 255, 255);
        }
