namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_color : ReportClass
    {
        public CR_color()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_color.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_color : Component, ICachedReport
    {
        public CachedCR_color()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
