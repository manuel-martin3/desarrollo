namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_consumos : ReportClass
    {
        public CR_consumos()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_consumos.rpt";
            }
            set
            {
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_perimes
        {
            get
            {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_procedenciaid
        {
            get
            {
    ...
    public class CachedCR_consumos : Component, ICachedReport
    {
        public CachedCR_consumos()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
