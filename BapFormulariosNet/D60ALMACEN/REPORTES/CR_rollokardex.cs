...
namespace BapFormulariosNet.D60ALMACEN.REPORTES {
    ...
    public class CR_rollokardex : ReportClass {
        
        public CR_rollokardex() {
        }
        
        public override string ResourceName {
            get {
                return "CR_rollokardex.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_rollokardex.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCR_rollokardex : Component, ICachedReport {
        
        public CachedCR_rollokardex() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CR_rollokardex rpt = new CR_rollokardex();
            rpt.Site = this.Site;
            return rpt;
        }
