namespace BapFormulariosNet.APT600100.REPORTES
{
    ...
    public class CR_diferencia_inv : ReportClass
    {
        public CR_diferencia_inv()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_diferencia_inv.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_diferencia_inv : Component, ICachedReport
    {
        public CachedCR_diferencia_inv()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
