namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_diferencia_inv_rollos_gen : ReportClass
    {
        public CR_diferencia_inv_rollos_gen()
        {
        }
        public override string ResourceName
        {
            get
            {
                return "CR_diferencia_inv_rollos_gen.rpt";
            }
            set
            {
            }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_diferencia_inv_rollos_gen.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_diferencia_inv_rollos_gen : Component, ICachedReport
    {
        public CachedCR_diferencia_inv_rollos_gen()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CR_diferencia_inv_rollos_gen();
            rpt.Site = Site;
            return rpt;
        }
