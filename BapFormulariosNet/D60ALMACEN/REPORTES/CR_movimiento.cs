namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_movimiento : ReportClass
    {
        public CR_movimiento()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_movimiento.rpt";
            }
            set
            {
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_convalor
        {
            get
            {
    ...
    public class CachedCR_movimiento : Component, ICachedReport
    {
        public CachedCR_movimiento()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
