namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_ubigeo_inv_rollos : ReportClass
    {
        public CR_ubigeo_inv_rollos()
        {
        }
        public override string ResourceName
        {
            get
            {
                return "CR_ubigeo_inv_rollos.rpt";
            }
            set
            {
            }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_ubigeo_inv_rollos.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_ubigeo_inv_rollos : Component, ICachedReport
    {
        public CachedCR_ubigeo_inv_rollos()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CR_ubigeo_inv_rollos();
            rpt.Site = Site;
            return rpt;
        }
