namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_diferencia_inv_rollos : ReportClass
    {
        public CR_diferencia_inv_rollos()
        {
        }
        public override string ResourceName
        {
            get
            {
                return "CR_diferencia_inv_rollos.rpt";
            }
            set
            {
            }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_diferencia_inv_rollos.rpt";
            }
            set
            {
            }
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_rollo
        {
            get
            {
        ...
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        public CrystalDecisions.Shared.IParameterField Parameter_fechatoma
        {
            get
            {
    ...
    public class CachedCR_diferencia_inv_rollos : Component, ICachedReport
    {
        public CachedCR_diferencia_inv_rollos()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CR_diferencia_inv_rollos();
            rpt.Site = Site;
            return rpt;
        }
