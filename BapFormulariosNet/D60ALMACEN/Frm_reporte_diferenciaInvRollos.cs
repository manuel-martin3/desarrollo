...
{
    public partial class Frm_reporte_diferenciaInvRollos : plantilla
    {
        ...
        public Frm_reporte_diferenciaInvRollos()
        {
            InitializeComponent();
        ...
        private void btn_imprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                miForma.dif = chkDiferencias.Checked;
                miForma.formulario = "Frm_reporte_diferenciaInvRollos";
                miForma.Show();
            }
            catch (Exception ex)
            {
        ...
        private void btn_imprimir_gen_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                miForma.rollo = rollo.Text.Trim();
                miForma.fechdoc = cmb_fechas.Text.ToString();
                miForma.formulario = "Frm_reporte_diferenciaInvRollos_gen";
                miForma.Show();
            }
            catch (Exception ex)
            {
