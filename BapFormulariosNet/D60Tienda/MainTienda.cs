...
{
    public partial class MainTienda : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void MainTienda_Load(object sender, EventArgs e)
        {
        ...
        private void MainTienda_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (MessageBox.Show("Quieres cerrar el Módulo?", "Mensaje del Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
            {
                e.Cancel = true;
        ...
        private void _RecuperarNcaja()
        {
            ...
            foreach (XmlElement nodo in lista)
            {
                ...
                perimes = nperimes[i] == null ? perimes : nperimes[i].InnerText;
            }
        }
