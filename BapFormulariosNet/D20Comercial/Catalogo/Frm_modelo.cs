...
namespace BapFormulariosNet.D20Comercial.Catalogo
{
    public partial class Frm_modelo : plantilla
    {
        ...
        {
            cbo_buscar.Items.Add(new System.Web.UI.WebControls.ListItem("NOMBRE MODELO", "01"));
            cbo_buscar.Items.Add(new System.Web.UI.WebControls.ListItem("COD MODELO", "02"));
            cbo_buscar.Items.Add(new System.Web.UI.WebControls.ListItem("COD MARCA", "03"));
        ...
        private void AyudaLinea(String lpdescrlike)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    frmayuda.sqlquery = "SELECT lineaid as Codigo, lineaname as Linea FROM tb_me_linea ";
        ...
        private void AyudaGrupo(String lpdescrlike)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    frmayuda.sqlquery = "SELECT grupoid as Codigo, gruponame as Marca FROM tb_me_grupo ";
                    frmayuda.sqlinner = string.Empty;
                    frmayuda.sqlwhere = "where moduloid=" + modulo;
                    frmayuda.sqland = "and ";
        ...
        private void SEGURIDAD_LOG(String accion)
        {
            ...
            try
            {
                ...
                BE.detalle = lineaid.Text.Trim() + grupoid.Text.Trim() + subgrupoid.Text.Trim() + "/" + subgruponame.Text.Trim().ToUpper() + "/" + XGLOSA;
        ...
        {
            gridsubgrupo.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            gridsubgrupo[e.ColumnIndex, e.RowIndex].Style.SelectionBackColor = Color.FromArgb(39, 95, 178);
