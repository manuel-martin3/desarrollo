namespace BapFormulariosNet.MERCADERIA.REPORTES
{
    ...
    public class CR_inventariado : ReportClass
    {
        public CR_inventariado()
        {
        }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_inventariado.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_inventariado : Component, ICachedReport
    {
        public CachedCR_inventariado()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
