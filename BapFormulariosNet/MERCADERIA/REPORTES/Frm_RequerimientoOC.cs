...
namespace BapFormulariosNet.MERCADERIA.REPORTES
{
    public partial class Frm_RequerimientoOC : plantilla
    {
        ...
        {
            griddetalleocompra.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            griddetalleocompra[e.ColumnIndex, e.RowIndex].Style.SelectionBackColor = Color.FromArgb(39, 95, 178);
