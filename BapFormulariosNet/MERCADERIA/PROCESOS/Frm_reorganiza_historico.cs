...
{
    public partial class Frm_reorganiza_historico : plantilla
    {
        ...
        public Frm_reorganiza_historico()
        {
            InitializeComponent();
        }
        ...
        private void Frm_reorganiza_historico_Load(object sender, EventArgs e)
        {
            ...
            switch (this.Parent.Parent.Name)
            {
                case "MainMercaderia":
                    ...
                    perimes = ((MERCADERIA.MainMercaderia)MdiParent).perimes;
                    break;
                case "MainAlmacen":
        ...
        private void btn_process_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (BL.ReorgAnio(VariablesPublicas.EmpresaID.ToString(), BE))
                {
