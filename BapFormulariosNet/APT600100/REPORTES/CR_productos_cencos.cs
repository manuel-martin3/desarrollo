namespace BapFormulariosNet.D60ALMACEN.REPORTES
{
    ...
    public class CR_productos_cencos : ReportClass
    {
        public CR_productos_cencos()
        {
        }
        public override string ResourceName
        {
            get
            {
                return "CR_productos_cencos.rpt";
            }
            set
            {
            }
        ...
        public override string FullResourceName
        {
            get
            {
                return "BapFormulariosNet.D60ALMACEN.REPORTES.CR_productos_cencos.rpt";
            }
            set
            {
            }
    ...
    public class CachedCR_productos_cencos : Component, ICachedReport
    {
        public CachedCR_productos_cencos()
        {
        }
        [Browsable(false)]
        [DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CR_productos_cencos();
            rpt.Site = Site;
            return rpt;
        }
