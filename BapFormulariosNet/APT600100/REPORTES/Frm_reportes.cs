    ...
    public partial class Frm_reportes : Form
    {
        ...
        private void active_mov_balancestock()
        {
            try
            {
                ...
                reporteRollokardex.DataDefinition.FormulaFields["empresaestable"].Text = "': " + localname.ToString() + "'";
                reporteRollokardex.DataDefinition.FormulaFields["empresatipo"].Text = "': " + moduloname.ToString() + "'";
                reporteRollokardex.DataDefinition.FormulaFields["empresaperiodo"].Text = "': " + VariablesPublicas.N_PrimerMes1.Trim() + " " + Peranio + "'";
                ...
                {
                    reporteRollokardex.DataDefinition.FormulaFields["mesperifin"].Text = "'-   " + VariablesPublicas.N_FinMes1.Trim() + " " + Peranio + "'";
                }
